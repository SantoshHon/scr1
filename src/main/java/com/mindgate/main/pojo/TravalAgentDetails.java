...
public class TravalAgentDetails {
	private int agentId;
	private String travelAgentName;
	SlabMaster slabMaster;
	LoginDetails loginDetails;
	
	public TravalAgentDetails() {
		// TODO Auto-generated constructor stub
	}

	public TravalAgentDetails(int agentId, String travelAgentName, SlabMaster slabMaster, LoginDetails loginDetails) {
		super();
